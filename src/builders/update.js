...
module.exports = (body, payload_index, core_index) => {
  ...
  if (body.core_serial && validator.isAlphanumeric(String(body.core_serial))) {
    query.$set[`rocket.first_stage.cores.${core_index}.core_serial`] = body.core_serial;
  }
  ...
  if (body.reused && validator.isBoolean(String(body.reused))) {
    query.$set[`rocket.first_stage.cores.${core_index}.reused`] = (body.reused === 'true');
  }
  if (body.land_success && validator.isBoolean(String(body.land_success))) {
    query.$set[`rocket.first_stage.cores.${core_index}.land_success`] = (body.land_success === 'true');
  }
  if (body.landing_type && validator.isAlphanumeric(String(body.landing_type))) {
    query.$set[`rocket.first_stage.cores.${core_index}.landing_type`] = body.landing_type;
  }
  if (body.landing_vehicle && validator.isAlphanumeric(String(body.landing_vehicle))) {
    query.$set[`rocket.first_stage.cores.${core_index}.landing_vehicle`] = body.landing_vehicle;
  }
  ...
  if (body.fairings_reused && validator.isBoolean(String(body.fairings_reused))) {
    query.$set['rocket.fairings.reused'] = (body.fairings_reused === 'true');
  }
  if (body.fairings_recovery_attempt && validator.isBoolean(String(body.fairings_recovery_attempt))) {
    query.$set['rocket.fairings.recovery_attempt'] = (body.fairings_recovery_attempt === 'true');
  }
  if (body.fairings_recovered && validator.isBoolean(String(body.fairings_recovered))) {
    query.$set['rocket.fairings.recovered'] = (body.fairings_recovered === 'true');
  }
  if (body.fairings_ship && validator.isAlphanumeric(String(body.fairings_ship))) {
    query.$set['rocket.fairings.ship'] = body.fairings_ship;
  }
  ...
  if (body.site_id && validator.isAlphanumeric(String(body.site_id))) {
    query.$set['launch_site.site_id'] = body.site_id;
  }
  if (body.site_name && validator.isAlphanumeric(String(body.site_name))) {
    query.$set['launch_site.site_name'] = body.site_name;
  }
  if (body.site_name_long && validator.isAlphanumeric(String(body.site_name_long))) {
    query.$set['launch_site.site_name_long'] = body.site_name_long;
  }
  ...
  if (body.telemetery && validator.isAlphanumeric(String(body.telemetery))) {
    query.$set.telemetery.flight_club = body.telemetery;
  }
  if (body.launch_success && validator.isBoolean(String(body.launch_success))) {
    query.$set.launch_success = (body.launch_success === 'true');
  }
  ...
  if (body.cap_serial && validator.isAlphanumeric(String(body.cap_serial))) {
    query.$set[`rocket.second_stage.payloads.${payload_index}.cap_serial`] = body.cap_serial;
  }
  ...
  if (body.payload_id && validator.isAlphanumeric(String(body.payload_id))) {
    query.$set[`rocket.second_stage.payloads.${payload_index}.payload_id`] = body.payload_id;
  }
  if (body.payload_type && validator.isAlphanumeric(String(body.payload_type))) {
    query.$set[`rocket.second_stage.payloads.${payload_index}.payload_type`] = body.payload_type;
  }
  ...
  if (body.payload_reused && validator.isBoolean(String(body.payload_reused))) {
    query.$set[`rocket.second_stage.payloads.${payload_index}.reused`] = (body.payload_reused === 'true');
  }
  if (body.customer && validator.isAlphanumeric(String(body.customer))) {
    query.$set[`rocket.second_stage.payloads.${payload_index}.customers`] = body.customer;
  }
  if (body.nationality && validator.isAlphanumeric(String(body.nationality))) {
    query.$set[`rocket.second_stage.payloads.${payload_index}.nationality`] = body.nationality;
  }
  if (body.manufacturer && validator.isAlphanumeric(String(body.manufacturer))) {
    query.$set[`rocket.second_stage.payloads.${payload_index}.manufacturer`] = body.manufacturer;
  }
  if (body.payload_type && validator.isAlphanumeric(String(body.payload_type))) {
    query.$set[`rocket.second_stage.payloads.${payload_index}.payload_type`] = body.payload_type;
  }
  if (body.orbit && validator.isAlphanumeric(String(body.orbit))) {
    query.$set[`rocket.second_stage.payloads.${payload_index}.orbit`] = body.orbit;
  }
  if (body.payload_reference_system && validator.isAlphanumeric(String(body.payload_reference_system))) {
    query.$set[`rocket.second_stage.payloads.${payload_index}.orbit_params.reference_system`] = body.payload_reference_system;
  }
  if (body.payload_regime && validator.isAlphanumeric(String(body.payload_regime))) {
    query.$set[`rocket.second_stage.payloads.${payload_index}.orbit_params.regime`] = body.payload_regime;
  }
  ...
  if (body.cargo_manifest && validator.isAlphanumeric(String(body.cargo_manifest))) {
    query.$set[`rocket.second_stage.payloads.${payload_index}.cargo_manifest`] = body.cargo_manifest;
  }
